...
from earnalotbot.bot.utils.downside_deviation import *
...
class CrawlEarningsWhispers:
    ...
    def __init__(self, end_date=10, start_date=-1):
        ...
        self.selenium_driver = webdriver.Chrome(executable_path=ubuntu_driver_loc, options=selenium_options)
        self.trading_days = []
    ...
    def move_around(self):
        try:
            ...
            self.selenium_driver.get(f"https://www.earningswhispers.com/calendar?sb=p&d={self.link_list_counter}&t=all&v=t")
