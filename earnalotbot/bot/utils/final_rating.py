...
env = Env()
def final_rating(ticker, fundamental_rating_multi=1, ta_rating_multi=1, revest_multi=0, downside_deviation_power=2):
    ...
    final_rating = float(fundamental * ta * revest) / downside_deviation
    return final_rating